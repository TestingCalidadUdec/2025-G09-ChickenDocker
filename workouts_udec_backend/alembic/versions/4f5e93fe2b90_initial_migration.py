...
Revision ID: 4f5e93fe2b90
Revises: 
Create Date: 2025-09-24 02:20:18.176571
...
def upgrade() -> None:
    ...
    sa.Column('exercise_type', sa.Enum('WEIGHT_BASED', 'TIME_BASED', name='exercisetype'), nullable=False),
